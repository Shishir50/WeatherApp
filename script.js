...
try {
    ...
    if (result.cloud_pct < 31) {
        document.getElementById('theme').className = "bg-gradient-to-r from-sky-400 to-blue-500 h-[100vh]";
        type.innerHTML = "CLEAR";    
    }
    else{
        // document.getElementById('theme').className = "bg-gradient-to-r from-gray-700 via-gray-900 to-black h-[100vh]";
        document.getElementById('theme').className = "bg-gradient-to-r from-gray-600 via-gray-700 to-gray-800 h-[100vh]";
